package br.fipp.pedidosfx.util;
            ...
            tabela.setItems(tabela.getItems().filtered(new Predicate() {
                ...
                public boolean test(Object o) {
                    try {
                        ...
                        field.setAccessible(true);
                        return ((String)field.get(o).toString()).toUpperCase().contains(tffiltro.getText().toUpperCase());
                    }
                    catch(Exception e){
...
/*
        ...
        ModalTable mt=new ModalTable(clientes,new String[]{"id","nome","email"},"nome");
        ...
        Cliente cliente = (Cliente)mt.getSelecionado();
        if (cliente!=null)
